...
namespace WGP_ASSIGNMENT
{
    abstract class Sprite
    {
        ...
        public Sprite(Texture2D textureImage, Color color, Vector2 position, Point frameSize,
        int collisionOffset, Point currentFrame, Point sheetSize, Vector2 speed)
            : this(textureImage, color, position, frameSize, collisionOffset, currentFrame,
